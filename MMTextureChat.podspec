...
Pod::Spec.new do |s|
 ...
 # 1
  ...
  s.homepage = "https://github.com/przemyslawcholewa/MMTextureChatSpec"


  # 6 - Replace this URL with your own Git URL from "Quick Setup"
  s.source = { :git => "https://github.com/przemyslawcholewa/MMTextureChatSpec.git", :tag => "#{s.version}"}
  ...
  # 9
  s.resources = "MMTextureChat/Assets.xcassets/**/*.{png}"
end
